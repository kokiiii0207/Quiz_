...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        tmpArray.append(["キムラコウキがお腹が空いた時に食べたくなるものは？","うどん","ガーリックライス","キムチ",1])
        tmpArray.append(["キムラコウキは大学何年生?","3年","4年","2年",1])
        tmpArray.append(["キムラコウキといえば？","ぽにょ","ぽにょう","ぽーにょ",1])
        tmpArray.append(["立教大学の英語名は?","St.Paul","St.ponyo","St.pooonyo",1])
        tmpArray.append(["ルミネといえば？","ルミネ池袋","ルミネ浦和","ルミネ越谷",1])
        tmpArray.append(["選択肢の答えが多いのは？","1","2","3",1])
        //------------------------ここから上にクイズを書く------------------------//
